...
public class Welcomepage extends JFrame {
	...
	public Welcomepage() {
		...
		lblNewLabel_4.setIcon(new ImageIcon("E:\\Library-Management-system-master\\images\\libraryWEL.png"));
		lblNewLabel_4.setBounds(178, 40, 253, 258);
		contentPane.add(lblNewLabel_4);
		
		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon("E:\\Library-Management-system-master\\images\\welcome (2).jpg"));
